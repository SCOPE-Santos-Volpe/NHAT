...
def upload_geojsons_to_RDS(table_name, geojson_folder_path = None, single_geojson_path = None):
    ...
    for geojson_path in geojson_paths:
        ...
        # gdf.to_postgis(table_name, con=sqlalchemy_conn, if_exists='append', index=False, dtype={'geom': Geometry(geometry_type='POLYGON', srid=4269)})
    ...
    # multipoly_gdf.to_postgis(table_name, con=sqlalchemy_conn, if_exists='append', index=False, dtype={'geom': Geometry(geometry_type='MULTIPOLYGON', srid=4269)})
