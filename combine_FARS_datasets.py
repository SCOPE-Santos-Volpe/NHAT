"""Combines all csv datasets (intended for FARS data) into 1 pandas dataframe and writes to a single .csv file.

Main function is combine_FARS_datasets. Helper functions take the folder path and get all .csv filenames, read a list of filenames into Pandas DataFrames, and concatenate a list of Pandas Dataframes into a single Pandas Dataframe.
