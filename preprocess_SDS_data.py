...
def preprocess_MA_SDS():
    ...
    * We care about the severity of the crash
    ...
    columns = ['CRASH_SEVERITY_DESCR', 'MAX_INJR_SVRTY_CL', 'NUMB_FATAL_INJR', 'NUMB_NONFATAL_INJR',
                'CRASH_DATE_TEXT', 'CRASH_HOUR', 'CRASH_TIME_2','YEAR', # some crash_hours don't exist
                'AMBNT_LIGHT_DESCR', 'WEATH_COND_DESCR', 'ROAD_SURF_COND_DESCR',
                'RDWY_JNCT_TYPE_DESCR', 'F_CLASS', 'F_F_CLASS', # ONE HOT, functional class linked
                'LAT','LON',
                'NON_MTRST_TYPE_CL', 'NON_MTRST_ACTN_CL', 'NON_MTRST_LOC_CL', # pedestrian vs cyclist
